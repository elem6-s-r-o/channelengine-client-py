...
from channelengine_client.models.i_purchase_order_line_by_filter import IPurchaseOrderLineByFilter  # noqa: E501
...
class TestIPurchaseOrderLineByFilter(unittest.TestCase):
    ...
    def testIPurchaseOrderLineByFilter(self):
        ...
        # model = channelengine_client.models.i_purchase_order_line_by_filter.IPurchaseOrderLineByFilter()  # noqa: E501
        pass
