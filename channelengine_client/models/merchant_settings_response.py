...
class MerchantSettingsResponse(object):
    ...
    def __init__(self, name=None, company_name=None, currency_code=None, default_culture_code=None, settings=None, vat=None):  # noqa: E501
        """MerchantSettingsResponse - a model defined in Swagger"""  # noqa: E501
        self._name = None
        ...
        if default_culture_code is not None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MerchantSettingsResponse, dict):
