...
class MerchantOrderResponse(object):
    ...
    swagger_types = {
        ...
        'sub_total_excl_vat': 'float',
        'total_excl_vat': 'float',
        'shipping_costs_excl_vat': 'float',
        'original_sub_total_excl_vat': 'float',
        'original_shipping_costs_excl_vat': 'float',
        'original_total_excl_vat': 'float',
        'original_sub_total_fee': 'float',
        'sub_total_fee': 'float',
        'original_order_fee': 'float',
        'order_fee': 'float',
    ...
    attribute_map = {
        ...
        'commercial_order_no': 'CommercialOrderNo',
        ...
        'sub_total_excl_vat': 'SubTotalExclVat',
        'total_excl_vat': 'TotalExclVat',
        'shipping_costs_excl_vat': 'ShippingCostsExclVat',
        'original_sub_total_excl_vat': 'OriginalSubTotalExclVat',
        'original_shipping_costs_excl_vat': 'OriginalShippingCostsExclVat',
        'original_total_excl_vat': 'OriginalTotalExclVat',
        'original_sub_total_fee': 'OriginalSubTotalFee',
        'sub_total_fee': 'SubTotalFee',
        'original_order_fee': 'OriginalOrderFee',
        'order_fee': 'OrderFee',
    ...
    def __init__(self, id=None, channel_name=None, channel_id=None, global_channel_name=None, global_channel_id=None, channel_order_support=None, channel_order_no=None, commercial_order_no=None, merchant_order_no=None, status=None, is_business_order=None, acknowledged_date=None, created_at=None, updated_at=None, closed_at=None, merchant_comment=None, billing_address=None, shipping_address=None, sub_total_incl_vat=None, sub_total_vat=None, shipping_costs_incl_vat=None, shipping_costs_vat=None, total_incl_vat=None, total_vat=None, original_sub_total_incl_vat=None, original_sub_total_vat=None, original_shipping_costs_incl_vat=None, original_shipping_costs_vat=None, original_total_incl_vat=None, original_total_vat=None, sub_total_excl_vat=None, total_excl_vat=None, shipping_costs_excl_vat=None, original_sub_total_excl_vat=None, original_shipping_costs_excl_vat=None, original_total_excl_vat=None, original_sub_total_fee=None, sub_total_fee=None, original_order_fee=None, order_fee=None, original_total_fee=None, total_fee=None, lines=None, phone=None, email=None, language_code=None, company_registration_no=None, vat_no=None, payment_method=None, payment_reference_no=None, currency_code=None, order_date=None, channel_customer_no=None, extra_data=None):  # noqa: E501
        ...
        self._commercial_order_no = None
        ...
        self._sub_total_excl_vat = None
        self._total_excl_vat = None
        self._shipping_costs_excl_vat = None
        self._original_sub_total_excl_vat = None
        self._original_shipping_costs_excl_vat = None
        self._original_total_excl_vat = None
        self._original_sub_total_fee = None
        self._sub_total_fee = None
        self._original_order_fee = None
        self._order_fee = None
        self._original_total_fee = None
        ...
        if commercial_order_no is not None:
            self.commercial_order_no = commercial_order_no
        ...
        if shipping_costs_incl_vat is not None:
        ...
        if sub_total_excl_vat is not None:
            self.sub_total_excl_vat = sub_total_excl_vat
        if total_excl_vat is not None:
            self.total_excl_vat = total_excl_vat
        if shipping_costs_excl_vat is not None:
            self.shipping_costs_excl_vat = shipping_costs_excl_vat
        if original_sub_total_excl_vat is not None:
            self.original_sub_total_excl_vat = original_sub_total_excl_vat
        if original_shipping_costs_excl_vat is not None:
            self.original_shipping_costs_excl_vat = original_shipping_costs_excl_vat
        if original_total_excl_vat is not None:
            self.original_total_excl_vat = original_total_excl_vat
        if original_sub_total_fee is not None:
            self.original_sub_total_fee = original_sub_total_fee
        if sub_total_fee is not None:
            self.sub_total_fee = sub_total_fee
        if original_order_fee is not None:
            self.original_order_fee = original_order_fee
        if order_fee is not None:
            self.order_fee = order_fee
        if original_total_fee is not None:
            self.original_total_fee = original_total_fee
        ...
        if payment_reference_no is not None:
    ...
    @property
    def commercial_order_no(self):
        """Gets the commercial_order_no of this MerchantOrderResponse.  # noqa: E501

        The order reference used by the channel for commercial purposes (e.g. on the invoice). Can be different from the ChannelOrderNo.  For example when the internal unique order reference is a unique id or guid, while the commercial order reference is (usually) a human readable reference that can be reused or used for multiple sellers by the channel.  # noqa: E501

        :return: The commercial_order_no of this MerchantOrderResponse.  # noqa: E501
        :rtype: str
        """
        return self._commercial_order_no

    @commercial_order_no.setter
    def commercial_order_no(self, commercial_order_no):
        """Sets the commercial_order_no of this MerchantOrderResponse.

        The order reference used by the channel for commercial purposes (e.g. on the invoice). Can be different from the ChannelOrderNo.  For example when the internal unique order reference is a unique id or guid, while the commercial order reference is (usually) a human readable reference that can be reused or used for multiple sellers by the channel.  # noqa: E501

        :param commercial_order_no: The commercial_order_no of this MerchantOrderResponse.  # noqa: E501
        :type: str
        """

        self._commercial_order_no = commercial_order_no
    ...
    def acknowledged_date(self):
        """Gets the acknowledged_date of this MerchantOrderResponse.  # noqa: E501

        The date the order was acknowledged in ChannelEngine.  # noqa: E501

        :return: The acknowledged_date of this MerchantOrderResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def acknowledged_date(self, acknowledged_date):
        """Sets the acknowledged_date of this MerchantOrderResponse.

        The date the order was acknowledged in ChannelEngine.  # noqa: E501

        :param acknowledged_date: The acknowledged_date of this MerchantOrderResponse.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def closed_at(self):
        """Gets the closed_at of this MerchantOrderResponse.  # noqa: E501

        The date the order was last updated in ChannelEngine.  # noqa: E501

        :return: The closed_at of this MerchantOrderResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def closed_at(self, closed_at):
        """Sets the closed_at of this MerchantOrderResponse.

        The date the order was last updated in ChannelEngine.  # noqa: E501

        :param closed_at: The closed_at of this MerchantOrderResponse.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def sub_total_excl_vat(self):
        """Gets the sub_total_excl_vat of this MerchantOrderResponse.  # noqa: E501


        :return: The sub_total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._sub_total_excl_vat

    @sub_total_excl_vat.setter
    def sub_total_excl_vat(self, sub_total_excl_vat):
        """Sets the sub_total_excl_vat of this MerchantOrderResponse.


        :param sub_total_excl_vat: The sub_total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._sub_total_excl_vat = sub_total_excl_vat

    @property
    def total_excl_vat(self):
        """Gets the total_excl_vat of this MerchantOrderResponse.  # noqa: E501


        :return: The total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._total_excl_vat

    @total_excl_vat.setter
    def total_excl_vat(self, total_excl_vat):
        """Sets the total_excl_vat of this MerchantOrderResponse.


        :param total_excl_vat: The total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._total_excl_vat = total_excl_vat

    @property
    def shipping_costs_excl_vat(self):
        """Gets the shipping_costs_excl_vat of this MerchantOrderResponse.  # noqa: E501


        :return: The shipping_costs_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._shipping_costs_excl_vat

    @shipping_costs_excl_vat.setter
    def shipping_costs_excl_vat(self, shipping_costs_excl_vat):
        """Sets the shipping_costs_excl_vat of this MerchantOrderResponse.


        :param shipping_costs_excl_vat: The shipping_costs_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._shipping_costs_excl_vat = shipping_costs_excl_vat

    @property
    def original_sub_total_excl_vat(self):
        """Gets the original_sub_total_excl_vat of this MerchantOrderResponse.  # noqa: E501


        :return: The original_sub_total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._original_sub_total_excl_vat

    @original_sub_total_excl_vat.setter
    def original_sub_total_excl_vat(self, original_sub_total_excl_vat):
        """Sets the original_sub_total_excl_vat of this MerchantOrderResponse.


        :param original_sub_total_excl_vat: The original_sub_total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._original_sub_total_excl_vat = original_sub_total_excl_vat

    @property
    def original_shipping_costs_excl_vat(self):
        """Gets the original_shipping_costs_excl_vat of this MerchantOrderResponse.  # noqa: E501


        :return: The original_shipping_costs_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._original_shipping_costs_excl_vat

    @original_shipping_costs_excl_vat.setter
    def original_shipping_costs_excl_vat(self, original_shipping_costs_excl_vat):
        """Sets the original_shipping_costs_excl_vat of this MerchantOrderResponse.


        :param original_shipping_costs_excl_vat: The original_shipping_costs_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._original_shipping_costs_excl_vat = original_shipping_costs_excl_vat

    @property
    def original_total_excl_vat(self):
        """Gets the original_total_excl_vat of this MerchantOrderResponse.  # noqa: E501


        :return: The original_total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._original_total_excl_vat

    @original_total_excl_vat.setter
    def original_total_excl_vat(self, original_total_excl_vat):
        """Sets the original_total_excl_vat of this MerchantOrderResponse.


        :param original_total_excl_vat: The original_total_excl_vat of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._original_total_excl_vat = original_total_excl_vat

    @property
    def original_sub_total_fee(self):
        """Gets the original_sub_total_fee of this MerchantOrderResponse.  # noqa: E501

        The sum of the fees on the order lines  (in the currency in which the order was paid for, see CurrencyCode).  # noqa: E501

        :return: The original_sub_total_fee of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._original_sub_total_fee

    @original_sub_total_fee.setter
    def original_sub_total_fee(self, original_sub_total_fee):
        """Sets the original_sub_total_fee of this MerchantOrderResponse.

        The sum of the fees on the order lines  (in the currency in which the order was paid for, see CurrencyCode).  # noqa: E501

        :param original_sub_total_fee: The original_sub_total_fee of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._original_sub_total_fee = original_sub_total_fee

    @property
    def sub_total_fee(self):
        """Gets the sub_total_fee of this MerchantOrderResponse.  # noqa: E501

        The sum of the fees on the order lines  (in the shop's base currency calculated using the exchange rate at the time of ordering).  # noqa: E501

        :return: The sub_total_fee of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._sub_total_fee

    @sub_total_fee.setter
    def sub_total_fee(self, sub_total_fee):
        """Sets the sub_total_fee of this MerchantOrderResponse.

        The sum of the fees on the order lines  (in the shop's base currency calculated using the exchange rate at the time of ordering).  # noqa: E501

        :param sub_total_fee: The sub_total_fee of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._sub_total_fee = sub_total_fee

    @property
    def original_order_fee(self):
        """Gets the original_order_fee of this MerchantOrderResponse.  # noqa: E501

        The fee on order itself (besides the fees on the order lines)  (in the currency in which the order was paid for, see CurrencyCode).  # noqa: E501

        :return: The original_order_fee of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._original_order_fee

    @original_order_fee.setter
    def original_order_fee(self, original_order_fee):
        """Sets the original_order_fee of this MerchantOrderResponse.

        The fee on order itself (besides the fees on the order lines)  (in the currency in which the order was paid for, see CurrencyCode).  # noqa: E501

        :param original_order_fee: The original_order_fee of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._original_order_fee = original_order_fee

    @property
    def order_fee(self):
        """Gets the order_fee of this MerchantOrderResponse.  # noqa: E501

        The fee on order itself (besides the fees on the order lines)  (in the shop's base currency calculated using the exchange rate at the time of ordering).  # noqa: E501

        :return: The order_fee of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def order_fee(self, order_fee):
        """Sets the order_fee of this MerchantOrderResponse.

        The fee on order itself (besides the fees on the order lines)  (in the shop's base currency calculated using the exchange rate at the time of ordering).  # noqa: E501

        :param order_fee: The order_fee of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """
    ...
    @property
    def original_total_fee(self):
        """Gets the original_total_fee of this MerchantOrderResponse.  # noqa: E501

        The total fee: the fees on the order lines + the fee on the order itself  (in the currency in which the order was paid for, see CurrencyCode).  # noqa: E501

        :return: The original_total_fee of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
        return self._original_total_fee

    @original_total_fee.setter
    def original_total_fee(self, original_total_fee):
        """Sets the original_total_fee of this MerchantOrderResponse.

        The total fee: the fees on the order lines + the fee on the order itself  (in the currency in which the order was paid for, see CurrencyCode).  # noqa: E501

        :param original_total_fee: The original_total_fee of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """

        self._original_total_fee = original_total_fee

    @property
    def total_fee(self):
        """Gets the total_fee of this MerchantOrderResponse.  # noqa: E501

        The total fee: the fees on the order lines + the fee on the order itself  (in the shop's base currency calculated using the exchange rate at the time of ordering).  # noqa: E501

        :return: The total_fee of this MerchantOrderResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def total_fee(self, total_fee):
        """Sets the total_fee of this MerchantOrderResponse.

        The total fee: the fees on the order lines + the fee on the order itself  (in the shop's base currency calculated using the exchange rate at the time of ordering).  # noqa: E501

        :param total_fee: The total_fee of this MerchantOrderResponse.  # noqa: E501
        :type: float
        """
    ...
    def language_code(self):
        """Gets the language_code of this MerchantOrderResponse.  # noqa: E501

        The language of the order. Has to be a 2-letter ISO language code.  # noqa: E501

        :return: The language_code of this MerchantOrderResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def language_code(self, language_code):
        """Sets the language_code of this MerchantOrderResponse.

        The language of the order. Has to be a 2-letter ISO language code.  # noqa: E501

        :param language_code: The language_code of this MerchantOrderResponse.  # noqa: E501
        :type: str
        """
